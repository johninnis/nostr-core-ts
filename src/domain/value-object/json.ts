 ...
 * into a `null`-or-value union, which composes with the rest of the codebase's null-guarded
 * parsing and removes one `deno-lint-ignore innis/no-catch-in-layer` per callsite.
 *
